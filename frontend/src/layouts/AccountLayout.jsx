...
function AccountLayout() {
  return (
    <main className="h-screen grid grid-cols-[1fr_31%]">
      <section className="grid grid-rows-[10%_1fr] border-r-2 border-gray-300 rounded-tr-2xl rounded-br-2xl">
        ...
        <div className="flex items-center justify-center relative h-full ">
          ...
          />
          <h1 className = 'absolute left-10 bottom-50 w-125 text-3xl'>
            AI Construction Progress Assistant — Simple, Real-Time Updates for
            Your Dream House
          </h1>
        </div>
      </section>
